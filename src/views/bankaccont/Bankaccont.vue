<template>
  <div>
    <TopBreadcrumb :titles="['銀行帳號管理','銀行帳號綁定']"></TopBreadcrumb>
    ...
    <el-card>
      ...
      <el-select v-model="queryInfo.coin" placeholder="狀態">
        <el-option label="未開通" value="0"></el-option>
        <el-option label="已開通" value="1"></el-option>
        <el-option label="現在使用中" value="2"></el-option>
        <el-option label="棄用" value="3"></el-option>
      </el-select>&nbsp;
